@extends('layouts.app')
@section('content')
    <div id="" class="container" style="background: url('{{asset('./img/header/header_our_cars.webp')}}');background-size:cover;background-position:center center;background-attachment:fixed;border-radius:0px 0px 30px 30px;" >
...
@foreach ($cars as $car )
<div class="card property-main animate__animated" style="border:#1d5c9b81 solid 1px;border-radius: 15px;overflow: hidden;">
    <div class="property-wrap">
        <div class="property-item">
             <div class="item-thumb mt-5 ml-3">
             ...
             <div class="item-body">
                ...
                <div class="row d-flex justify-content-center ">
                    <div class="col-2 col-lg-4 text-center box-icon p-3  ">
                    ...
                    <div class="col-12">
                            <div class="property-price h3 text-center" style="color: #454545;">
