@extends('layouts.app')
@section('content')
    <div id="" class="container" style="background: url('{{asset('./img/header/slide3.jpg')}}');background-size:cover;background-position:center center;background-attachment:fixed;border-radius:0px 0px 30px 30px;" >
        ...
        <div class="property-item">
             <div class="item-thumb mt-5 ml-3">
                 <a class="hover-effect" href="{{route('user.cars.show' , $car->uuid) }}">
                  <img class="img-fluid p-lg-2"  src="{{asset($car->img)}}" alt="" >
                 </a>
             </div>
             <div class="item-body">
                ...
                <div class="row d-flex justify-content-center p-3">
                    <div class="col-3  text-center box-icon  ">
                    ...
                    {{-- <div class="col-12">
                            <div class="property-price h3 text-center" style="color: #F4D160;">
