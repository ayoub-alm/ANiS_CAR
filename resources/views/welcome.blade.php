    ...
    <section class="property section-padding">
      <div class="container">
       ...
       {{-- @foreach ($cars as $car)
            ...
            <div class="card my-1 hover-effect col-lg-12 property-main  animate__animated"  >
              <div class="row g-0">
                ...
                <div class="col-lg-3 text-center  my-auto">
                  <br>
                  <h3  class="h1 bolder " style="color: #F4D160;">
          ...
          <div class="col-12">
            <div class="text-center">
              <a href="{{ route('cars')}}" class="btn btn-common">Voir tout</a>
            </div> 
          </div>  
        </div>
      </div>
...
<section id="team" class="section-padding text-center">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="section-title-header text-center">
              <h2 class="section-title">Nos agents</h2>            </div>
          </div>
        </div>
        <div class="row">
...
.Illustration-1-hex { color: #1D5D9B; }
