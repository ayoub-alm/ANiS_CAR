  ...
  <section class="container" >
    <div class="row">
      <div class="col-lg-6 mx-auto my-auto" >
        <h2 class=" text-center " style="color: #559fee;font-family: 'Bangers', cursive;', sans-serif;">
            ANIS AUTO
        </h2>
        ...
        <h2 class="display-6 text-center ">
          <span class="" id="contentSpan" ></span>
          <br> 
          location de voiture   <br>au maroc
        </h2>
      </div>
...
setInterval(changerContenu, 3000);
      </script>
      <div class="col-lg-6 ">
        <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
          ...
          <div class="carousel-inner shadow-lg rounded" style="">
            <div class="carousel-item active">
              <img class="d-block w-100 img-fluid rounded" height="400px" src="https://www.etags.com/blog/wp-content/uploads/2020/09/AdobeStock_294950461.jpeg" alt="First slide">
            </div>
            <div class="carousel-item ">
              <img class="d-block w-100 img-fluid rounded" height="400px" src="https://static.medias24.com/content/uploads/2022/11/28/Dacia_Stepway.png?x38928" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100 img-fluid rounded" height="400px" src="https://images.cars.com/cldstatic/wp-content/uploads/Mercedes-AMG-EQE-SUV-2024-exterior-oem-01.jpg" alt="Third slide" >
            </div>
          </div>
...
<link href="https://fonts.googleapis.com/css2?family=Bangers&display=swap" rel="stylesheet">
            @foreach ($cars as $car)
            <div class="card mb-2 hover-effect col-lg-12 property-main  animate__animated"  >
              <div class="row g-0">
                ...
                <div class="col-md-4">
                  <div class="card-body">
                    <h5 class="card-title h1 text-center font-weight-bold" style="font-family: 'Bangers', cursive;', sans-serif;">{{$car->name}}  
                        {{-- <div class="label-inner">
                          <span class="label-status label bg-green">For Sale</span>
                        </div> --}}
                    </h5>
                ...
                <div class="col-lg-3 text-center">
                  <br>
                  <h3  class="h1 bolder " style="color: #559FEE;">
          ...
          <div class="col-12">
            <div class="text-center">
              <a href="{{ route('cars')}}" class="btn btn-common">Browse All</a>
            </div> 
          </div>  
        </div>
      </div>
    ...
    <section id="team" class="section-padding text-center">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="section-title-header text-center">
              <h2 class="section-title">Nos agents</h2>
              {{-- <p>Duis aute irure dolor in reprehed in volupted velit esse dolore</p> --}}
            </div>
          </div>
        </div>
              ...
              <div class="item">
                <div class="property-main">
                  <div class="property-wrap">
                    <div class="property-item">
                      <div class="item-thumb">
                        <a class="hover-effect" href="{{route('user.cars.show' , 1) }}">
                      ...
                      <div class="item-body">
                        <h3 class="property-title"><a href="{{route('user.cars.show' , 1) }}">Amazing oceanfront apartment</a></h3>
                ...
                <div class="property-main">
                  <div class="property-wrap">
                    <div class="property-item">
                      ...
                      <div class="item-body">
                        <h3 class="property-title"><a href="{{route('user.cars.show' , 1) }}">Family Condo</a></h3>
                ...
                <div class="property-main">
                  <div class="property-wrap">
                    <div class="property-item">
                      ...
                      <div class="item-body">
                        <h3 class="property-title"><a href="{{route('user.cars.show' , 1) }}">Guaranteed modern home</a></h3>
                ...
                <div class="property-main">
                  <div class="property-wrap">
                    <div class="property-item">
                      ...
                      <div class="item-body">
                        <h3 class="property-title"><a href="{{route('user.cars.show' , 1) }}">Family home for sale</a></h3>
                ...
                <div class="property-main">
                  <div class="property-wrap">
                    <div class="property-item">
                      ...
                      <div class="item-body">
                        <h3 class="property-title"><a href="{{route('user.cars.show' , 1) }}">Luxury home for sale</a></h3>
